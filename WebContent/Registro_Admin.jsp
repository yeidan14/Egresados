      ...
      <div id="dpSidebarBody" class="sidebar-body">
        ...
        <div class="content">
            ...
            <div class="content-body">
                <form name="agregar" class="parsley-style-1" action="Registrar_Admin.do" data-parsley-validate novalidate>
          ...
          <div class="alert alert-success" role="alert">
             Perfecto Admin Registrado !
            </div>
             <%}        
             if(registrado=="Existe"){%>
             <div class="alert alert-warning" role="alert">
             El Admin ya esta  Registrado !
            </div>
             <%}         %>
            ...
            <div class="input-group-prepend">
              <span class="input-group-text">Nombre </span>
                ...
                <input type="text" maxlength="15"  name="name" class="form-control"  required=""/>
          </div>
            ...
            <div class="input-group-prepend">
              <span class="input-group-text">Usuario </span>
                ...
                <input type="text" maxlength="50"  name="user" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" required=""/>
          </div>
           ...
           <div class="input-group mg-b-10">
            <div class="input-group-prepend">
              <span class="input-group-text">Email </span>
                ...
                <input type="email" maxlength="15"  name="email" class="form-control"  required=""/>
          </div>
            ...
            <div class="input-group-prepend">
              <span class="input-group-text">Clave</span>
                ...
                <input type="password"  name="pass" class="form-control" aria-label="Dollar amount (with dot and two decimal places)" required=""/>
          </div>
          ...
          <%
            ...
            rs = smt.executeQuery("select * from programa");
            //Creamo la Tabla:     
        %>
...
<div class="wd-md-50p">
              ...
              <select name="programa" class="custom-select" required="">              
             ...
             <span class="input-group-text">Tipo de Admin</span>
                        <select name="supe" class="custom-select" required="">            
